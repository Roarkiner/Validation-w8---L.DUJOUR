...
class Magician extends Character
{
    ...
    public function magicBolt($target) {
        ...
        $status = "$this->name lance un éclair magique sur $target->name à qui il reste " . $target->getHealthPoints() . " points de vie! Il reste $this->magicPoints points de magie à $this->name !";
        return $status;
    }
    ...
    public function attack($target) {
        ...
        $status = "$this->name donne un coup de bâton à $target->name ! Il reste " . $target->getHealthPoints() . " points de vie à $target->name !";
        return $status;
    }
}
